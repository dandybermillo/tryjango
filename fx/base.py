...
class Field_column(object):
    ...
    def __init__(self, field=None, header=None, attrs=None, header_attrs=None,
        ...
        print(f"field:{field},attrs {attrs},self.header:{self.header} ")
        self.instance_order = Field_column.instance_order
        Field_column.instance_order += 1
